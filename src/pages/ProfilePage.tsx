            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="mt-2 flex flex-wrap justify-center sm:justify-start gap-2">
                  <span className="px-2 py-1 bg-blue-50 text-blue-700 text-xs font-bold rounded uppercase">Acesso Ativo</span>
                  <span className="px-2 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded uppercase">ID: {user?.id.slice(0, 8)}</span>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-xl border shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">Cadastro de Pacientes</span>
                <span className="text-green-600 font-bold">Sim</span>
              </div>
              <div className="flex items-center justify-between text-sm">
            ...
            <div className="mt-6 p-3 bg-blue-50 rounded-lg">
              <p className="text-xs text-blue-700 leading-relaxed">
                Você possui perfil de <strong>{profile?.role}</strong>. Algumas ações podem estar restritas conforme as políticas da clínica.
              </p>
            </div>
          </div>
        </div>
